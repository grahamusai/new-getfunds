...
const Hero = () => {
  return (
    <>
    <div className="block md:hidden md:relative z-10  h-screen  px-10 md:px-24 lg:px-32 2xl:px-[14rem] pt-[70px]">
        {/* Background Video */}
        ...
        {/* Text Content */}
        <div className="relative flex flex-col items-start  lg:items-start lg:text-left mt-12 text-white">
          <div className="w-full md:w-1/2">
            ...
            <p className="leading-relaxed text-gray-300 mt-10 text-xl">
              ...
              working capital providers giving SMEs instant access to a range of
              funding solutions with just one paperless application and no
              capital raising fees.
            </p>

            {/* Align Apply Now button to the left */}
            <div className="  justify-start items-center gap-7 mt-14 ">
              <a
