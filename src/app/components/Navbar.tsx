...
const Navbar = () => {
  ...
  return (
    <nav className="mr-[12rem]  bg-[#00000066] fixed w-full z-20 px:14  top-0 start-0 text-white">
      <PreNav />
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between pt-2 mx-auto pb-5">
        <a
          href="/"
              ...
              <ul>
                <li>
                  <div>
                    <a
                      href="/contact"
                      className="bg-transparent dark:bg-white dark:text-black text-white flex justify-center group/modal-btn mt-[-9px]"
                    >
